...
Jos sen miettiminen tuntuu monimutkaiselta, niin omasta näkökulmastasihan kysymys on yksinkertaisempi: Kuinka paljon enemmän/vähemmän maksat, verojen ja maksujen muodossa, Suomessa käyttämistäsi palveluista? Ja kuinka paljon vastaavat palvelut maksavat täällä vakuutusten ja huomattavasti pienempien verojen muodossa? Voihan olla että joidenkin tapauksessa Suomen vaihtoehto on halvempi. Emme väitä että Boquete olisi aina kaikille paras vaihtoehto, eikä tarvitsekaan olla.
